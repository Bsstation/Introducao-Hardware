...
const strings = {
	...
	"Português": {
		"AdvanceHelp": "Este é um jogo desenvolvido por Jeferson Galdino.", 
		"Audio": "Audio",
		"AutoPlay": "Auto",
		"AutoPlaySpeed": "Velocidade do autoplay",
		...
		"iOSAudioWarning": "Configurações de audio não suportadas no iOS.",
		...
		"Loading": "Carregando",
		"LoadingMessage": "Aguarde enquanto os assets são carregados.",
		...
		"NoSavedGames": "Sem jogos salvos.",
		"NoAutoSavedGames": "Sem jogos salvos automaticamente.",

		"Overwrite": "Sobrescrever",

		"QuickButtons": "Botões do menu",
		"Quit": "Sair",
		...
		"Save": "Salvar",
		"SaveButon": "Abrir Tela de Salvamento.",
		"SaveInSlot": "Salvar no slot",
		"Settings": "Opções",
		"SettingsButton": "Abrir Tela de Configurações.",
		"Show": "Mostrar",
		"SlotDeletion": "Tem certeza que quer deletar esse slot?",
		"SlotOverwrite": "Tem certeza que quer sobrescrever esse slot?",
		"Sound": "Volume do Som",
		"Start": "Iniciar",
		"Stop": "Parar",
